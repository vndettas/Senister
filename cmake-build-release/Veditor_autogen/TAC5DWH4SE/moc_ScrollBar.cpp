...
static constexpr auto qt_meta_stringdata_ZN9ScrollBarE = QtMocHelpers::stringData(
    "ScrollBar"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9ScrollBarE[] = {
...
Q_CONSTINIT const QMetaObject ScrollBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9ScrollBarE.offsetsAndSizes,
    qt_meta_data_ZN9ScrollBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9ScrollBarE_t,
        // Q_OBJECT / Q_GADGET
...
void *ScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9ScrollBarE.stringdata0))
