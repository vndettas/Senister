...
namespace Constants {
    ...
    // --Numerator plugin--
    inline constexpr uint32_t NUMERATION_WIDTH = 48;
    ...
    inline constexpr uint32_t CODE_LINES_Y_OFFSET = 22;
    inline constexpr uint32_t CODE_BOTTOM_MARGIN = 17;
    inline constexpr uint32_t CODE_VIEWPORT_HEIGHT = WINDOW_HEIGHT - CODE_LINES_Y_OFFSET;

    // --File bar plugin--
    inline constexpr uint32_t FILE_BAR_HEIGHT = 22;
    inline constexpr uint32_t FILE_BAR_X_OFFSET = NUMERATION_WIDTH; 
    inline constexpr uint32_t FILE_BAR_Y_OFFSET = CODE_LINES_Y_OFFSET;
    inline constexpr uint32_t FILE_BAR_TEXT_HEIGHT = 15;
    inline constexpr uint32_t FILE_BAR_TAB_WIDTH = 38;
